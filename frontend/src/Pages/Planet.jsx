...
const Planet = () => {
    ...
    const fecthPlanet = () => {
        axios.get('http://localhost:3000/api/planets/' + id)
                        ...
                        <div className="planet-specs">
                            <div className="planet-spec-item">
                                ...
                                <div>
                                    ...
                                    <div className="planet-spec-value"><span> Da </span>{planet?.temperature_min} <span> a </span> {planet?.temperature_max}      <span> °C</span></div>
                                </div>
                            </div>
                            <div className="planet-spec-item">
                                <div className="planet-spec-icon">
                                ...
                                <div>
                                    ...
                                    <div className="planet-spec-value">{planet?.planet_size}            <span> KM&#178;</span></div>
                                </div>
                            </div>
                            <div className="planet-spec-item">
                                <div className="planet-spec-icon">
                        ...
                        <div className="packages">
                            ...
                            <div className="package-card">
                                ...
                                <ul className="package-features">
                                    <li><i className="fas fa-check"></i> Certificato di proprietà</li>
                                    <li><i className="fas fa-check"></i> Coordinate GPS galattiche</li>
                                    <li><i className="fas fa-check"></i> Mappa personalizzata</li>
                                    <li><i className="fas fa-check"></i> 50m² di terreno</li>
                                </ul>
                            </div>
                            ...
                            <div className="package-card">
                                ...
                                <ul className="package-features">
                                    ...
                                    <li><i className="fas fa-check"></i> Coordinate GPS galattiche</li>
                                    <li><i className="fas fa-check"></i> Mappa personalizzata</li>
                                    <li><i className="fas fa-check"></i> 100m² di terreno</li>
                                    <li><i className="fas fa-check"></i> Cornice Premium inclusa</li>
                                </ul>
                            </div>
                            ...
                            <div className="package-card">
                                ...
                                <ul className="package-features">
                                    ...
                                    <li><i className="fas fa-check"></i> Coordinate GPS galattiche</li>
                                    <li><i className="fas fa-check"></i> Mappa personalizzata</li>
                                    <li><i className="fas fa-check"></i> 150m² di terreno</li>
                                    <li><i className="fas fa-check"></i> Cornice Premium inclusa</li>
                                    <li><i className="fas fa-check"></i> Nome sul registro pubblico</li>
