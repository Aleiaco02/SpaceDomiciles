...
export default function SearchPage() {
  ...
  const filtered = planets
    ...
    .filter(p =>
      p.temperature_min >= filters.temperatureMin
    )
    .filter(p =>
      p.temperature_max <= filters.temperatureMax
    )
    .filter(p =>
      p.planet_size >= filters.sizeMin &&
      p.planet_size <= filters.sizeMax
    )
    .filter(p =>
      p.surface_available >= filters.surfaceAvailable
    )
    ;
