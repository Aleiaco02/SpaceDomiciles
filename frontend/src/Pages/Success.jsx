    ...
    return (
        <div className="galaxy-page">
            ...
            >
                ...
                nelle profondità del nostro sistema interstellare. <br /><br />

                <span style={{ color: "violet", fontSize: "28px" }}>Tra pochi istanti riceverai una mail contenente: <br /></span>


                ✨ Il riepilogo dettagliato del tuo ordine <br />
                ✨ Il certificato ufficiale di proprietà del tuo oggetto celeste <br />
                ✨ Tutte le informazioni utili per seguire il viaggio del pacco attraverso la galassia <br /><br />

                Grazie per aver scelto di viaggiare con noi.
                Il tuo acquisto non è solo un ordine:
                è un piccolo passo verso l’infinito. 🌠
            </p>
